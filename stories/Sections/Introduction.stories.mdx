...
This style guide resides as a central repository for the best practices we follow, a set of recommended approaches and the design guidelines/components we use.

This style guide is also open source. If you feel that there are rooms for improvement, feel free to raise an issue or a pull request to the repository.
